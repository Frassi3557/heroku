<html>
   <body>
      <form action = "https://vef-2019-v.herokuapp.com/result" method = "POST">
         ...
         <h3>Eftir hádegi:</h3>
         <input type="checkbox" name="Eftir hádegi" value="Python2"> Python 2<br>
         <input type="checkbox" name="Eftir hádegi" value="Javascript2"> Javascript 2<br>
         <input type="checkbox" name="Eftir hádegi" value="Gagnagrunnur2"> Gagnagrunnur 2<br>
